...
$sqlQuery = "INSERT INTO manager_users_table SET user_name = '".$user_name."', surname = '".$surname."', email = '".$email."', 
             phone_number = '".$phone_number."', manager_id = '".$manager_id."', created_at = '".$created_at."', 
