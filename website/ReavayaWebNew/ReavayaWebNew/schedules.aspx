<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="schedules.aspx.cs" Inherits="ReavayaWebNew.schedules" %>
                                    ...
                                    <div class="stats">
                                        <div class="text-center mb-10">
                                            <div class="login-footer">
                                                <asp:Button ID="loginStats" runat="server" type="submit" class="btn login-btn" Text="Add Bus Schedules" OnClick="loginStats_Click"/>
                                            </div>

                                            <br />

                                            <div class="login-footer">
                                                <asp:Button ID="ridesStats" runat="server" type="submit" class="btn login-btn" Text="Update Bus Schedules" OnClick="ridesStats_Click"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
