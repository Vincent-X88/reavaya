<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="update_schedule.aspx.cs" Inherits="ReavayaWebNew.update_schedule" %>
                        ...
                        <form runat="server">
                            <div class="login-heading">
                                <span>Update Bus Schedule</span> 
                                      ...
                                      <asp:Label ID="lblSuccessMessages" runat="server" Text="" CssClass="success-message" Visible="false" Style="color: green;"></asp:Label>
                                 <asp:Label ID="Label2" runat="server" Text="" CssClass="unsuccess-message" Visible="false"></asp:Label>
                            </div>
                            ...
                            <div class="login-footer">
                                <asp:Button ID="btnUpdateSchedule" runat="server" type="submit" class="btn login-btn" Text="Update Schedule" OnClick="btnAddSchedule_Click" />
                            </div>
                        </form>
                    </div>
                </div>
