<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="ReavayaWebNew.Error" %>
...
<div class="mobile_menu d-block d-lg-none"></div>
    ...
    <div style="text-align: center; width: 30%;">
        <h1 style="color:blue;">Transaction Unsuccessful!</h1>
        <p>Your transaction was Unsuccessfully. Please try again!</p>
        <img src="assets/img/error.png" alt="Green checkmark" style="max-width:100%; height:auto;">
